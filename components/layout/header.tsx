...
const Header = () => {
    return (
        <header className="flex items-center justify-between h-18 shrink-0 gap-2 px-6 py-4 transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-18 dark:bg-[#273142]">
