...
//                         <button
//                             title={color.name}
//                             className="grid w-full place-content-center gap-2 rounded-lg border-2 border-transparent py-1.5 shadow-sm transition duration-300 focus-visible:outline-none hover:border-primary h-[38px] !cursor-pointer"
...
//     // Apply selected color into CSS variables
...
//     // যখন ইউজার নতুন color সিলেক্ট করবে
//     const handleColorChange = (hex: string) => {
//         setSelectedColor(hex);
//         applyColor(hex);
//         localStorage.setItem("primaryColor", hex); // ✅ এখানে color save হচ্ছে
//     };

//     // পেজ reload হলে localStorage থেকে color restore হবে
//     useEffect(() => {
...
//                             className={`grid w-full place-content-center gap-2 rounded-lg border-2 py-1.5 shadow-sm transition duration-300 focus-visible:outline-none h-[38px] ${selectedColor === color.hex
//                                 ? "border-primary"
//                                 : "border-transparent"
//                                 }`}
//                             style={{ backgroundColor: color.hex }}
