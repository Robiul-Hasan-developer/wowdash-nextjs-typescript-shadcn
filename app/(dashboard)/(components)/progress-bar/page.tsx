        ...
        <div className="col-span-12 sm:col-span-6">
          <DefaultCardComponent title="Default Progress">
            <div className="flex items-center flex-col gap-6">
              <div className="w-full bg-blue-600/10 rounded-full h-2">
                <div className="bg-blue-600 h-2 rounded-full dark:bg-blue-600" style={{ width: "20%" }}></div>
              </div>
              <div className="w-full bg-blue-600/10 rounded-full h-2">
                <div className="bg-blue-600 h-2 rounded-full dark:bg-blue-600" style={{ width: "35%" }}></div>
              </div>

              <div className="w-full bg-blue-600/10 rounded-full h-2">
                <div className="bg-blue-600 h-2 rounded-full dark:bg-blue-600" style={{ width: "50%" }}></div>
              </div>

              <div className="w-full bg-blue-600/10 rounded-full h-2">
                <div className="bg-blue-600 h-2 rounded-full dark:bg-blue-600" style={{ width: "75%" }}></div>
              </div>

              <div className="w-full bg-blue-600/10 rounded-full h-2">
                <div className="bg-blue-600 h-2 rounded-full dark:bg-blue-600" style={{ width: "90%" }}></div>
              </div>
            </div>
        ...
        <div className="col-span-12 sm:col-span-6">
          <DefaultCardComponent title="Progress with multiple color">
            <div className="flex items-center flex-col gap-6 position-relative">
              <div className="w-full bg-blue-600/10 rounded-full h-2 overflow-hidden">
                <div className="bg-blue-600 h-2 rounded-full dark:bg-blue-600 animate-progress transition-all ease-out duration-1000" style={{ width: "20%" }}></div>
              </div>
          ...
          <DefaultCardComponent title="Gradient Progress">
            <div className="flex items-center flex-col gap-6 position-relative">
              <div className="w-full bg-gradient-to-l to-blue-600/50 from-blue-600/10 rounded-full h-2 overflow-hidden">
                <div className="bg-gradient-to-l to-blue-700 from-blue-500 h-2 rounded-full dark:bg-blue-600 animate-progress transition-all ease-out duration-1000" style={{ width: "20%" }}></div>
              </div>
