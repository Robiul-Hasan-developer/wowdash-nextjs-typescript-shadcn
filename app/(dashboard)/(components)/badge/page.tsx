      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <DefaultCardComponent title="Default Badges">
          <div className="flex flex-wrap items-center gap-3">
            ...
            <span className="badge text-sm font-semibold bg-transparent px-5 py-1.5 rounded text-blue-600">Link</span>
        ...
        <DefaultCardComponent title="Outline Badges">
          <div className="flex flex-wrap items-center gap-3">
            <span className="badge text-sm font-semibold border border-blue-600 text-blue-600 bg-transparent px-5 py-1.5 rounded">Primary</span>
        ...
        <DefaultCardComponent title="Soft Badges">
          <div className="flex flex-wrap items-center gap-3">
            ...
            <span className="badge text-sm font-semibold bg-transparent px-5 py-1.5 rounded text-blue-600">Link</span>
            <span className="badge text-sm font-semibold bg-light-100 dark:bg-slate-600 px-5 py-1.5 rounded text-secondary-light">Light</span>
          </div>
        </DefaultCardComponent>
        ...
        <DefaultCardComponent title="Rounded Badges">
          <div className="flex flex-wrap items-center gap-3">
            ...
            <span className="badge text-sm font-semibold rounded-full bg-transparent px-5 py-1.5 text-blue-600">Link</span>
        ...
        <DefaultCardComponent title="Number Rounded Badges">
          <div className="flex flex-wrap items-center gap-3">
            ...
            <span className="badge text-sm font-semibold w-8 h-8 flex justify-center items-center rounded-full border border-blue-600 text-blue-600 dark:text-blue-500">1</span>
        ...
        <DefaultCardComponent title="Number Square Badges">
          <div className="flex flex-wrap items-center gap-3">
            ...
            <span className="badge text-sm font-semibold w-8 h-8 flex justify-center items-center rounded border border-blue-600 text-blue-600 dark:text-blue-500">1</span>
