...
const ViewProfile = () => {
    return (
        <>
            ...
            <div>
                <div className="card h-full rounded-lg border-0 p-8">
                        ...
                        <form action="#">
                            <div className="grid md:grid-cols-2 gap-x-5">
                                ...
                                <div className="mb-5">
                                    ...
                                    <Input type="url" className="border border-neutral-300 px-5 dark:border-slate-500 focus:border-blue-600 dark:focus:border-blue-600 focus-visible:border-blue-600 h-12 rounded-lg !shadow-none !ring-0" id="Website" placeholder="Website URL" />
                                </div>
                                <div className="mb-5">
                                ...
                                <div className="mb-5">
                                    ...
                                    <Select>
                                        <SelectTrigger id='city' className="border border-neutral-300 px-5 dark:border-slate-500 focus:border-blue-600 dark:focus:border-blue-600 focus-visible:border-blue-600 h-12 !rounded-lg !shadow-none !ring-0 !h-[48px] !w-full">
                                ...
                                <div className="mb-5">
                                    ...
                                    <Select>
                                        <SelectTrigger id='state' className="border border-neutral-300 px-5 dark:border-slate-500 focus:border-blue-600 dark:focus:border-blue-600 focus-visible:border-blue-600 h-12 !rounded-lg !shadow-none !ring-0 !h-[48px] !w-full">
                                ...
                                <div className="mb-5">
                                    ...
                                    <Input type="text" className="border border-neutral-300 px-5 dark:border-slate-500 focus:border-blue-600 dark:focus:border-blue-600 focus-visible:border-blue-600 h-12 rounded-lg !shadow-none !ring-0" id="zip" placeholder="Zip Code" />
                                </div>
                                <div className="mb-5 col-span-2">
                                    ...
                                    <Input type="text" className="border border-neutral-300 px-5 dark:border-slate-500 focus:border-blue-600 dark:focus:border-blue-600 focus-visible:border-blue-600 h-12 rounded-lg !shadow-none !ring-0" id="address" placeholder="Enter Your Address" />
                                </div>
