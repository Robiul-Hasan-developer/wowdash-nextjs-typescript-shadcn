            ...
            <CardContent className="card-body p-6">
                ...
                <ul className="flex flex-wrap items-center justify-center mb-3 gap-3">
                    <li className="flex items-center gap-2">
                        ...
                        <span className="text-neutral-600 text-sm font-semibold">Income
                    ...
                    <li className="flex items-center gap-2">
                        ...
                        <span className="text-neutral-600 text-sm font-semibold">Expense
                            <span className="text-blue-light font-bold text-xl ms-1"> $3,120</span>
                        </span>
                    </li>
                </ul>

                <DoubleLineChartTwo colors={["#487FFF", "#FF9F29"]} />
