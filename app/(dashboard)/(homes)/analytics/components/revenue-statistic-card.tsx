                ...
                <ul className="flex flex-wrap items-center justify-center my-3 gap-6">
                    <li className="flex flex-col gap-1">
                        <div className="flex items-center gap-2">
                            <span className="w-[8px] h-[8px] rounded-[50rem] bg-blue-600"></span>
                            <span className="text-neutral-600 text-sm dark:text-neutral-100 font-semibold">Profit </span>
                        </div>
                        <div className="flex items-center gap-2">
                            <h6 className="mb-0">$26,201</h6>
                            <span className="text-green-500 flex items-center gap-1 text-sm font-bolder">
                                10%
                                <i className="ri-arrow-up-s-fill flex"></i>
                            </span>
                        </div>
                    </li>
                    <li className="flex flex-col gap-1">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-red-600 flex items-center gap-1 text-sm font-bolder">
                                10%
                                <i className="ri-arrow-down-s-fill flex"></i>
                            </span>
                        </div>
                    </li>
                </ul>
