...
//         const filteredItems = documents.filter((document) => index !== document.id)
//         setRemoveItem(filteredItems)
//     }
...
//                                         <Button
//                                             type="button"
//                                             className="w-8 h-8 flex justify-center items-center text-center bg-red-600/10 hover:bg-red-600 hover:text-white duration-300 active:scale-75 text-red-600 rounded-full"
//                                         >
//                                             <Trash width={18} />
//                                         </Button>
//                                         <Button
//                                             type="button"
//                                             className="w-8 h-8 flex justify-center items-center text-center bg-green-600/10 hover:bg-green-600 hover:text-white duration-300 active:scale-75 text-green-600 rounded-full"
//                                         >
//                                             <Download width={18} />
//                                         </Button>
//                                     </div>
