    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mt-6">
                ...
                <div className="flex flex-wrap items-center mt-4"> 
                  <ul className="shrink-0">
                    <li className="flex items-center gap-2 mb-7">
                      ...
                      <span className="text-neutral-600 text-sm font-medium">Total: 400</span>
                    </li>
                    <li className="flex items-center gap-2 mb-7">
                      <span className="w-3 h-3 rounded-full bg-warning-600"></span>
                      <span className="text-neutral-600 text-sm font-medium">New: 400</span>
                    </li>
                    <li className="flex items-center gap-2">
                      <span className="w-3 h-3 rounded-full bg-primary-600"></span>
                      <span className="text-neutral-600 text-sm font-medium">Active: 1400</span>
                    </li>
                  </ul>
          ...
          <div className="card-body p-6">
              ...
              <ul className="flex flex-wrap items-center justify-center mt-8">
                <li className="flex items-center gap-2 me-7">
                  <span className="w-3 h-3 rounded-full bg-success-600"></span>
                  <span className="text-neutral-600 text-sm font-medium">Paid: 400</span>
                </li>
                <li className="flex items-center gap-2 me-7">
                  <span className="w-3 h-3 rounded-full bg-info-600"></span>
                  <span className="text-neutral-600 text-sm font-medium">Pending: 400</span>
                </li>
                <li className="flex items-center gap-2">
                  <span className="w-3 h-3 rounded-full bg-warning-600"></span>
                  <span className="text-neutral-600 text-sm font-medium">Overdue: 1400</span>
                </li>
              </ul>
      ...
      <div className="lg:col-span-6 2xl:col-span-4">
        <div className="card rounded-lg border-0">
          ...
          <div id="world-map" className="h-[200px] bg-neutral-100 dark:bg-neutral-600/30"></div>
